...
output_dir = r"D:\py\pycode_V2\transcriptomics_analysis_V3" 
...
# 1. Data Loading
# ==============================================================================
print(f"Loading data from 'RA_ane_transcriptomic50%_transformer.xlsx'...")
try:
    data = pd.read_excel('RA_ane_transcriptomic50%_transformer.xlsx', header=0)
except FileNotFoundError:
    print("\nERROR: 'RA_ane_transcriptomic50%_transformer.xlsx' not found.")
...
# ==============================================================================
# 2. Model Definition with Enhanced Regularization
# ==============================================================================
class TransformerModel(nn.Module):
    def __init__(self, input_dim, dropout_rate=0.5):  # Increased dropout
        super(TransformerModel, self).__init__()
        
        # Architecture Selection Rationale:
        # - 2 attention heads: balances model capacity and computational efficiency
        # - 3 encoder layers: sufficient depth for complex pattern recognition while avoiding over-parameterization
        # - Dropout rate 0.5: strong regularization to prevent overfitting
        n_heads = 6
    ...
    def forward(self, x, return_attention_weights=False):
        ...
        x_processed = attn_output.squeeze(1)
...
# ==============================================================================
# 3. Overfitting Detection Algorithm - Consistent with Metabolomics
# ==============================================================================
def detect_overfitting(train_losses, val_losses, window_size=5, threshold_ratio=1.4):  # MODIFIED: Use same threshold as metabolomics
    """
    Detects overfitting in loss curves with criteria consistent with metabolomics analysis.
    """
    ...
    # Multiple overfitting indicators with consistent standards
    indicators = []
    
    # Indicator 1: Validation loss increases while training loss decreases
    if val_trend > 0.015 and train_trend < -0.015:  
    ...
    if current_val > min_val * 1.3 and min_val_idx < len(val_losses) - 5:  
...
# ==============================================================================
# 4. Cross-Validation Training and Evaluation - Consistent Structure
# ==============================================================================

# --- Cross-validation and hyperparameter settings ---
n_splits = 5
kfold = StratifiedKFold(n_splits=n_splits, shuffle=True, random_state=SEED)
n_components = 30  # PCA components for transcriptomics
dropout_rate = 0.5
...
for fold, (train_idx, val_idx) in enumerate(kfold.split(X, y)):
    ...
    best_loss, patience, counter, num_epochs = np.inf, 10, 0, 100
    ...
    # --- MODIFIED: Plot loss curves with fixed colors consistent with metabolomics ---
    ...
    # MODIFIED: English title and labels consistent with metabolomics
...
# ==============================================================================
# 5. Aggregate Results and Generate Final Plots - Unified Style
# ==============================================================================
...
colors = ['red', 'green']  # Consistent with metabolomics
...
feature_importance_df = pd.DataFrame({
    'Gene': gene_names[sorted_indices], 
...
# --- 6. Plot Attention Stability Heatmap for Top 30 Genes ---
top_30_indices = sorted_indices[:30]  # Top 30 genes based on importance
top_30_names = gene_names[top_30_indices]
top_30_importances_per_fold = np.array(feature_importances)[:, top_30_indices]

plt.figure(figsize=(14, 12))
sns.heatmap(top_30_importances_per_fold.T, 
            xticklabels=[f"Fold {i+1}" for i in range(n_splits)], 
            yticklabels=top_30_names, 
            cmap="viridis", 
            linewidths=.5)
plt.title('Attention-based Feature Importance Stability (Top 30 Genes)')
...
# Check if requirements are met (only overfitting check remains)
